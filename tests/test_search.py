...
class TestGoogleBooksSearch:
    ...
    def test_successful_title_author_search(self):
        with patch('requests.get') as mock_get:
            ...
            results = hp.search_google_books_multiple('Gatsby Fitzgerald')
    ...
    def test_search_with_missing_image(self):
        with patch('requests.get') as mock_get:
            ...
            results = hp.search_google_books_multiple('test')
...
class TestISBNSearch:
    ...
    def test_valid_isbn_lookup(self):
        with patch('requests.get') as mock_get:
            ...
            results = hp.search_google_books_by_isbn('1234567890')
    ...
    def test_invalid_isbn_format(self):
        with patch('requests.get') as mock_get:
            ...
            results = hp.search_google_books_by_isbn('invalid-isbn')
